...
public class Utils {
    ...
    static com.assessor.android.camera.Error errorFromThrowable(Throwable throwable) {
        return errorFromThrowable(throwable, com.assessor.android.camera.Error.ERROR_DEFAULT_CODE);
    }

    private static com.assessor.android.camera.Error errorFromThrowable(Throwable throwable, int fallback) {
        return new com.assessor.android.camera.Error(codeFromThrowable(throwable, fallback), messageFromThrowable(throwable));
    }
