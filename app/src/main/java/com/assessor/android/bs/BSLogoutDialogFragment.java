...
public class BSLogoutDialogFragment extends BottomSheetDialogFragment implements RetrofitServiceListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.action_logout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    RetrofitService.getInstance(getActivity()).onLogOut(mServiceListener);
                }
                getDialog().dismiss();
            }
        });
