...
public class CameraController implements CameraControllerI {
    ...
    protected static final ImmutableSetMultimap<FlashMode, String> FLASH_MODE_MAP =
            ImmutableSetMultimap.of(
                    FlashMode.AUTO, Parameters.FLASH_MODE_AUTO,
                    FlashMode.OFF, Parameters.FLASH_MODE_OFF,
                    FlashMode.ON, Parameters.FLASH_MODE_TORCH,
                    FlashMode.ON, Parameters.FLASH_MODE_ON
            );
    ...
    protected synchronized boolean setFlashModeParams(FlashMode flashMode, Parameters params) {
