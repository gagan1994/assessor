...
public class FFmpegRecorderActivity extends AbstractDynamicStyledActivity implements
    ...
    public static final String REQUEST_PARAMS_KEY = BuildConfig.APPLICATION_ID + ".FFmpegRecorderActivityParams";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mProgressView = findViewById(R.id.recorder_progress);
        ...
        mCameraPreviewView = findViewById(R.id.recorder_view);
        ...
        mTapToFocusView = findViewById(R.id.tap_to_focus_view);
